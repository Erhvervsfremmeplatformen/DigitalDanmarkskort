...
export const Categories: TypeDictionary = {
    ...
    2: { text:'Konstrueret miljø', description: 'herunder simulering(facilitet som skaber et kunstigt miljø fx en vindtunnel)'},
    4: { text:'Real world miljø', description: '(et virkeligt miljø, som bruges til at teste, demonstere eller udvikle, fx et living lab eller et rensningsanlæg, hvor en del af spildevandet afledes til forsøg)'},
    8: { text:'Datamiljø', description: 'herunder computerkapacitet og databaser (fx serverkapacitet eller biobanker)'},
...
export const ServiceTypes: TypeDictionary = {
    ...
    4: { text:'Komplet service', description: 'herunder gennemførelse af fx forskning, test, demonstration eller udvikling uden brugeren'},
    8: { text:'sel (ikke teknisk support til faciliteten)', description: ''},
